...
const PATHOLOGY_SLIDES: Slide[] = [
  ...
  },
  {
    ...
    category: "Haematology", stain: "Wright-Giemsa", difficulty: "Advanced", type: "Pathology",
    imageUrl:    SLIDES.aml,
    analyzeUrl:  SLIDES.aml,
    description: "Myeloblasts with delicate chromatin and Auer rods on a blood/marrow smear.",
    diagnosisHint: "Acute Myeloid Leukaemia (AML) — sheets of myeloblasts with high N:C ratio, fine open chromatin, prominent nucleoli and cytoplasmic Auer rods (pathognomonic); ≥20% marrow blasts, MPO+, CD13/CD33/CD117+",
  },
  {
    id: "p8e",
    ...
    category: "Haematology", stain: "Wright-Giemsa", difficulty: "Advanced", type: "Pathology",
    imageUrl:    SLIDES.all,
    analyzeUrl:  SLIDES.all,
    description: "Small-to-medium lymphoblasts with scant cytoplasm and condensed chromatin.",
    diagnosisHint: "Acute Lymphoblastic Leukaemia (ALL) — sheets of lymphoblasts with scant agranular cytoplasm, condensed chromatin, indistinct nucleoli, no Auer rods; TdT+, CD19/CD10+ (B-ALL) or CD3/CD7+ (T-ALL), commonest childhood leukaemia",
  },
  {
    id: "p8f",
    ...
    category: "Haematology", stain: "Wright-Giemsa", difficulty: "Advanced", type: "Pathology",
    imageUrl:    SLIDES.cml,
    analyzeUrl:  SLIDES.cml,
    description: "Marked leucocytosis with the full spectrum of maturing granulocytes and basophilia.",
    diagnosisHint: "Chronic Myeloid Leukaemia (CML) — marked neutrophilic leucocytosis with left shift through all maturation stages, absolute basophilia and eosinophilia, few blasts in chronic phase; BCR-ABL1 t(9;22) Philadelphia chromosome",
  },
  {
    id: "p8g",
    title: "Chronic Lymphocytic Leukaemia (CLL)",
    category: "Haematology", stain: "Wright-Giemsa", difficulty: "Intermediate", type: "Pathology",
    imageUrl:    SLIDES.cll,
    analyzeUrl:  SLIDES.cll,
    description: "Numerous small mature lymphocytes with smudge (smear) cells on the film.",
    diagnosisHint: "Chronic Lymphocytic Leukaemia (CLL) — absolute lymphocytosis of small mature lymphocytes with clumped 'soccer-ball' chromatin and characteristic smudge (smear) cells; CD5+/CD23+/CD19+, dim CD20 and surface Ig",
  },
  // ── Hepatology ────────────────────────────────────────────────────────
  {
    id: "p9",
