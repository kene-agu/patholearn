...
const NORMAL_SLIDES: Slide[] = [
  {
    ...
    imageUrl: wiki("Histopathology_of_liver_zones.jpg"),
    analyzeUrl: proxy(wiki("Histopathology_of_liver_zones.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Normal_lung_(3660695207).jpg"),
    analyzeUrl: proxy(wiki("Normal_lung_(3660695207).jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Histology-kidney.jpg"),
    analyzeUrl: proxy(wiki("Histology-kidney.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Normal_Epidermis_and_Dermis_with_Intradermal_Nevus_10x.JPG"),
    analyzeUrl: proxy(wiki("Normal_Epidermis_and_Dermis_with_Intradermal_Nevus_10x.JPG")),
  ...
  },
  {
    ...
    imageUrl: wiki("Large_intestine_histology.jpg"),
    analyzeUrl: proxy(wiki("Large_intestine_histology.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Thyroid_gland_microscope.jpg"),
    analyzeUrl: proxy(wiki("Thyroid_gland_microscope.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Lymph_node_histology.jpg"),
    analyzeUrl: proxy(wiki("Lymph_node_histology.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Cardiac_muscle_histology_400x.jpg"),
    analyzeUrl: proxy(wiki("Cardiac_muscle_histology_400x.jpg")),
  ...
  },
  {
    ...
    title: "Normal Spleen",
    category: "Haematology", stain: "H&E", difficulty: "Beginner", type: "Normal Histology",
    imageUrl: wiki("Histology_of_Spleen.jpg"),
    analyzeUrl: proxy(wiki("Histology_of_Spleen.jpg")),
...
const PATHOLOGY_SLIDES: Slide[] = [
  // ── Oncology ────────────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Micrograph_of_invasive_squamous_cell_carcinoma_-_150x.jpg"),
    analyzeUrl: proxy(wiki("Micrograph_of_invasive_squamous_cell_carcinoma_-_150x.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Micrograph_of_ductal_carcinoma_with_marked_nuclear_pleomorphism_and_increased_mitotic_rate.jpg"),
    analyzeUrl: proxy(wiki("Micrograph_of_ductal_carcinoma_with_marked_nuclear_pleomorphism_and_increased_mitotic_rate.jpg")),
  ...
  },
  {
    ...
    category: "Oncology", stain: "H&E", difficulty: "Intermediate", type: "Pathology",
    imageUrl: wiki("DCIS_-_high_grade.jpg"),
    analyzeUrl: proxy(wiki("DCIS_-_high_grade.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Breast_fibroadenoma_(2).jpg"),
    analyzeUrl: proxy(wiki("Breast_fibroadenoma_(2).jpg")),
  ...
  // ── Gastroenterology ────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Carcinoma_Stomach_10x.jpg"),
    analyzeUrl: proxy(wiki("Carcinoma_Stomach_10x.jpg")),
  ...
  },
  {
    ...
    category: "Gastroenterology", stain: "H&E", difficulty: "Intermediate", type: "Pathology",
    imageUrl: wiki("Adenocarcinoma_of_the_colon-histology.JPG"),
    analyzeUrl: proxy(wiki("Adenocarcinoma_of_the_colon-histology.JPG")),
  ...
  },
  {
    ...
    category: "Gastroenterology", stain: "H&E", difficulty: "Intermediate", type: "Pathology",
    imageUrl: wiki("Crohn's_disease_-_granuloma_2_-_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Crohn's_disease_-_granuloma_2_-_high_mag.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Esophageal_adenocarcinoma_-_low_mag.jpg"),
    analyzeUrl: proxy(wiki("Esophageal_adenocarcinoma_-_low_mag.jpg")),
  ...
  // ── Nephrology ────────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Crescentic_glomerulonephritis_HE_stain.JPEG"),
    analyzeUrl: proxy(wiki("Crescentic_glomerulonephritis_HE_stain.JPEG")),
  ...
  },
  {
    ...
    category: "Nephrology", stain: "H&E", difficulty: "Advanced", type: "Pathology",
    imageUrl: wiki("Histopathology_of_clear_cell_renal_cell_carcinoma,_grade_1,_high_magnification.jpg"),
    analyzeUrl: proxy(wiki("Histopathology_of_clear_cell_renal_cell_carcinoma,_grade_1,_high_magnification.jpg")),
  ...
  },
  {
    ...
    category: "Nephrology", stain: "H&E", difficulty: "Advanced", type: "Pathology",
    imageUrl: wiki("Wilms_tumor_-_very_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Wilms_tumor_-_very_high_mag.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Nodular_glomerulosclerosis_-_very_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Nodular_glomerulosclerosis_-_very_high_mag.jpg")),
  ...
  // ── Pulmonology ──────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Srifhistology3.jpg"),
    analyzeUrl: proxy(wiki("Srifhistology3.jpg")),
  ...
  // ── Infectious Disease ───────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Pulmonary_tuberculosis_-_Necrotizing_granuloma_(6545185917).jpg"),
    analyzeUrl: proxy(wiki("Pulmonary_tuberculosis_-_Necrotizing_granuloma_(6545185917).jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Mycobacterium_tuberculosis_Ziehl-Neelsen_stain.jpg"),
    analyzeUrl: proxy(wiki("Mycobacterium_tuberculosis_Ziehl-Neelsen_stain.jpg")),
  ...
  // ── Haematology ──────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Hodgkin_Disease,_Reed-Sternberg_Cell.jpg"),
    analyzeUrl: proxy(wiki("Hodgkin_Disease,_Reed-Sternberg_Cell.jpg")),
  ...
  },
  {
    ...
    category: "Haematology", stain: "H&E", difficulty: "Advanced", type: "Pathology",
    imageUrl: wiki("Diffuse_large_B_cell_lymphoma_-_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Diffuse_large_B_cell_lymphoma_-_high_mag.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Multiple_myeloma_(intramedullary)_2_-_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Multiple_myeloma_(intramedullary)_2_-_high_mag.jpg")),
  ...
  // ── Hepatology ────────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Ground_glass_hepatocytes_high_mag_2.jpg"),
    analyzeUrl: proxy(wiki("Ground_glass_hepatocytes_high_mag_2.jpg")),
  ...
  // ── Neuropathology ────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Glioblastoma_-_MIB1_and_histo.jpg"),
    analyzeUrl: proxy(wiki("Glioblastoma_-_MIB1_and_histo.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Meningioma_-_histopathology_-_psammomatous.jpg"),
    analyzeUrl: proxy(wiki("Meningioma_-_histopathology_-_psammomatous.jpg")),
  ...
  // ── Endocrinology ─────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Papillary_carcinoma_thyroid_-_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Papillary_carcinoma_thyroid_-_high_mag.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Pheochromocytoma_-_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Pheochromocytoma_-_high_mag.jpg")),
  ...
  // ── Dermatology ───────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Melanoma_1_-_very_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Melanoma_1_-_very_high_mag.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Basal_cell_carcinoma_histology.jpg"),
    analyzeUrl: proxy(wiki("Basal_cell_carcinoma_histology.jpg")),
  ...
  // ── Gynaecology ───────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Cervical_intraepithelial_neoplasia_-_CIN_III.jpg"),
    analyzeUrl: proxy(wiki("Cervical_intraepithelial_neoplasia_-_CIN_III.jpg")),
  ...
  },
  {
    ...
    category: "Gynaecology", stain: "H&E", difficulty: "Intermediate", type: "Pathology",
    imageUrl: wiki("Endometrial_adenocarcinoma_(3).jpg"),
    analyzeUrl: proxy(wiki("Endometrial_adenocarcinoma_(3).jpg")),
  ...
  // ── Urology ───────────────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Prostatic_adenocarcinoma_gleason_pattern_3.jpg"),
    analyzeUrl: proxy(wiki("Prostatic_adenocarcinoma_gleason_pattern_3.jpg")),
  ...
  // ── Musculoskeletal ───────────────────────────────────────────────────
  {
    ...
    imageUrl: wiki("Osteosarcoma_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Osteosarcoma_high_mag.jpg")),
  ...
  },
  {
    ...
    imageUrl: wiki("Giant_cell_tumour_of_bone_-_high_mag.jpg"),
    analyzeUrl: proxy(wiki("Giant_cell_tumour_of_bone_-_high_mag.jpg")),
