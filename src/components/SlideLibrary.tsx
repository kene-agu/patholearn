...
interface Slide {
  ...
  imageUrl: string;
  description: string;
  diagnosisHint: string; // passed to AI so it confirms features rather than guessing
}
...
const PATHOLOGY_SLIDES: Slide[] = [
  ...
  },
  {
    ...
    diagnosisHint: "Pulmonary Tuberculosis — caseating (necrotising) granuloma with central pink amorphous caseous necrosis, surrounding epithelioid histiocytes, Langhans giant cells, lymphocytic cuff",
  },
  {
    id: "p8",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {filtered.map((slide) => (
              <div
                ...
                onClick={() => onSelect(slide.imageUrl, slide.diagnosisHint)}
              >
                {/* Thumbnail */}
