    ...
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="card p-4 space-y-2">
              ...
              <div className="h-7 bg-slate-100 dark:bg-slate-700 rounded animate-pulse w-3/4" />
            </div>
          ))}
        </div>
        {/* Chart skeleton */}
        <div className="card p-5 space-y-3">
          ...
          <div className="h-32 bg-slate-100 dark:bg-slate-700 rounded-lg animate-pulse" />
        </div>
        {/* List skeleton */}
        <div className="card p-5 space-y-3">
          <div className="h-4 bg-slate-100 dark:bg-slate-700 rounded animate-pulse w-1/4" />
          {[70, 55, 85, 60].map((w, i) => (
            <div key={i} className="h-3 bg-slate-100 dark:bg-slate-700 rounded animate-pulse" style={{ width: `${w}%` }} />
          ))}
        </div>
      </div>
    );
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-semibold text-slate-800 dark:text-slate-200">Deck mastery</h2>
          </div>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm p-6">
        <div className="flex items-center gap-2 mb-5">
          ...
          <h2 className="font-semibold text-slate-800 dark:text-slate-200">Weak areas</h2>
        ...
        {stats.weakAreas.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="font-medium text-slate-700 dark:text-slate-300">No weak areas yet</p>
            <p className="text-sm text-slate-400 mt-1">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm p-6">
        <div className="flex items-center gap-2 mb-5">
          ...
          <h2 className="font-semibold text-slate-800 dark:text-slate-200">This week</h2>
        </div>
