              ...
              <>
                ...
                >
                  {subscribing
                    ...
                    : <><Crown className="w-4 h-4" /> Upgrade to Premium — {formatPrice(subscription.monthlyPrice)}/mo</>}
                </button>
              </>
            )}
            ...
            {subscription.isExpired && (
              <div className="space-y-3">
                ...
                >
                  {subscribing
                    ? <><Loader2 className="w-4 h-4 animate-spin" /> Starting checkout…</>
                    : <><Crown className="w-4 h-4" /> Subscribe — {formatPrice(subscription.monthlyPrice)}/month</>}
                </button>
              </div>
            )}
          </div>
