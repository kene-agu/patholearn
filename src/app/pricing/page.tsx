...
const FEATURES = [
  ...
  {
    category: "Smart Learn (Upload & Learn from Your Docs)",
    items: [
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Payments are processed via Flutterwave in Nigerian Naira (₦). You can pay with debit/credit cards (local and international), bank transfer, USSD, and mobile money.",
  },
  {
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-amber-100 text-xs mt-0.5">
                    Limited-time offer for new subscribers — don&apos;t miss it
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-7 flex flex-col">
            ...
            <ul className="space-y-2.5 mb-7 flex-1">
              {[
                ...
                { icon: GraduationCap,  text: "Smart Learn — upload PDFs, slides & docs" },
