...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Start free for 14 days. Unlimited AI slide analysis, full quiz bank, PDF export and more. From ₦3,000/month.",
    url: "/pricing",
  },
  twitter: {
    title: "PathoLearn Pricing — From ₦3,000/month",
    description:
      "Start free for 14 days. Unlimited AI slide analysis, full quiz bank and more. From ₦3,000/month.",
  },
};
